        ...
        while (retries < maxRetries) {
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const attachmentItems = document.querySelectorAll('tbody.p-table--th-left td a');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.eumseong.go.kr/www/selectEminwonList.do?pageUnit=10&searchCnd=all&key=352&ofr_pageSize=10&pageIndex=1',
            required: true
        })
