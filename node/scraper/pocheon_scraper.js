        ...
        while (retries < maxRetries) {
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const listItems = document.querySelectorAll('ul.view_attach li');
                    ...
                    listItems.forEach(item => {
                        ...
                        if (anchor) {
                            // The file name is the text content of the anchor tag.
                            const fileName = anchor.textContent.trim();
                            // The download link is the href attribute of the anchor tag.
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.pocheon.go.kr/www/selectEminwonList.do?key=12563&notAncmtSeCode=01',
            required: true
        })
