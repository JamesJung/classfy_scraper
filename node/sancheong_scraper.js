        ...
        while (retries < maxRetries) {
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    console.log("dateText 추출 결과:", dateText)
                    console.log("announcement.listDate:", announcement ? announcement.listDate : 'announcement 없음')
                    ...
                    if (!dateText) {
                        ...
                        if (announcement && announcement.listDate) {
                            console.log("텍스트 텍스트 등록일!!")
                            dateText = announcement.listDate
                        }

                    }
                    console.log("최종 dateText:", dateText)
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.sancheong.go.kr/www/selectBbsNttList.do?key=158&bbsNo=118&nttNo=150242&searchCtgry=&searchCnd=all&searchKrwd=&pageIndex=1&integrDeptCode=&deleteAt=N',
            required: true
        })
