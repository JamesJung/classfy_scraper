            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#contents', '.content', '.main', '.article', '.post',
                        '#main', '#article', '#post',
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.gn.go.kr/www/selectGosiNttList.do?pageUnit=10&searchCnd=all&key=263&searchGosiSe=01,04,06&pageIndex=1',
            required: true
        })
