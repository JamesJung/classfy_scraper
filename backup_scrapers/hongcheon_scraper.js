            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#contents', 'table.p-table', '.bbs__view', '.content_box', '.program--contents',
                    ...
                    const fileLinks = document.querySelectorAll('ul.p-attach li');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.hongcheon.go.kr/www/selectEminwonList.do?key=278',
            required: true
        })
