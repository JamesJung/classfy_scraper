            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#contents', '#board', '.content', '.contents_wrap', '.program--contents',
                    ...
                    const goDownloadLinks = document.querySelectorAll('.p-attach a.p-attach__link');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.sd.go.kr/main/selectBbsNttList.do?bbsNo=184&key=1473&',
            required: true
        })
