...
class AnnouncementScraper {
    ...
    convertJsDownloadToUrl(jsUrl) {
        ...
        if (matches && matches.length === 4) {
            ...
            return `https://eminwon.shinan.go.kr/emwp/jsp/ofr/FileDown.jsp?user_file_nm=${enc_user_file_nm}&sys_file_nm=${enc_sys_file_nm}&file_path=${enc_file_path}`;
        }
