...
class GjcityScraper extends AnnouncementScraper {
    constructor(options = {}) {
        const defaultOptions = {
            siteCode: 'gjcity',
            baseUrl: 'https://www.gjcity.go.kr/portal/saeol/gosi/list.do?mId=0202010000&token=1757577778347',
        ...
        try {
            ...
            if (attachment.onclick) {
                ...
                if (goDownloadMatch) {
                    ...
                    downloadUrl = `https://eminwon.gjcity.go.kr/emwp/jsp/ofr/FileDown.jsp?user_file_nm=${enc_user_file_nm}&sys_file_nm=${enc_sys_file_nm}&file_path=${enc_file_path}`;
...
if (require.main === module) {
    ...
    const scraper = new GjcityScraper({
