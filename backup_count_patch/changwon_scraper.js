            ...
            try {
                ...
                const announcements = await this.page.evaluate((selectors) => {
                    ...
                    rows.forEach((row, index) => {
                        ...
                        console.log("selectors.titleSelector", selectors.titleSelector, selectors.dateSelector)
                        ...
                        console.log(titleElement, dateElement)
            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#conts', '#body_content', 'tbody.p-table--th-left', '.view', '.contents_wrap', '.program--contents',
                    ...
                    const fileLinks = document.querySelectorAll('div.attach1 ul li a');
                    let results = [];
...
function setupCLI() {
    return yargs
        ...
        .option('p', {
            type: 'number',
            description: '시작 페이지 번호 (go-page의 별칭)',
            default: null
        })
        .option('output', {
            alias: 'o',
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.changwon.go.kr/cwportal/10310/10438/10439.web',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.list2table1 table.tttac tbody tr'
        })
...
async function main() {
    ...
    // -p 파라미터가 있으면 우선 사용, 없으면 go-page 사용
    const startPage = argv.p || argv.goPage;
