            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#contents', '#contBody', '.content', '.contents_wrap', '.program--contents',
                    ...
                    const fileLinks = document.querySelectorAll('a.p-attach__link');

                    fileLinks.forEach(link => {
                        const fileNameElement = link.querySelector('span:last-of-type');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.ydp.go.kr/www/selectEminwonList.do?menuFlag=01&key=2851&',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.bbs table.p-table tbody tr'
        })
