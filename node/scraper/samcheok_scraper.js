            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#content', '#contents', 'table.p-table', '.bbs1view1', '.contents_wrap', '.program--contents',
                    ...
                    const goDownloadLinks = document.querySelectorAll('.attach1 a.filename');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.samcheok.go.kr/media/00084/00095.web',
            required: true
        })
