            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#conts', '#contents', 'tbody.p-table--th-left', '.view', '.contents_wrap', '.program--contents',
                    ...
                    fileLinks.forEach(link => {
                        // 파일 이름은 <span> 태그 내에 있으므로, 해당 요소를 찾습니다.
                        // 첫 번째 <span>은 아이콘 텍스트이고, 두 번째 <span>이 파일 이름입니다.
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.yp21.go.kr/www/selectBbsNttList.do?bbsNo=5&key=1119',
            required: true
        })
