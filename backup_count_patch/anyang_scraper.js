        ...
        while (retries < maxRetries) {
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const fileLinks = document.querySelectorAll('td ul li');
                    const results = [];
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.anyang.go.kr/main/emwsWebList.do?key=4101&searchGosiSe=01,04',
            required: true
        })
