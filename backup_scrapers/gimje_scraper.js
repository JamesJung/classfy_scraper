            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    fileItems.forEach(item => {
                        // Find the download link element within the current item.
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.gimje.go.kr/board/list.gimje?boardId=BBS_0000044&menuCd=DOM_000000104003000000&contentsSid=196&cpath=',
            required: true
        })
