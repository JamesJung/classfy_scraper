            ...
            try {
                ...
                const announcements = await this.page.evaluate((selectors) => {
                    ...
                    rows.forEach((row, index) => {
                        ...
                        console.log("titleElement", titleElement, dateElement)
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.guri.go.kr/www/selectGosiNttList.do?key=387&searchGosiSe=01,04,06',
            required: true
        })
