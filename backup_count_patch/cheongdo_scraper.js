            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#conts', '#contBody', '.content', '.contents_wrap', '.program--contents',
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.cheongdo.go.kr/portal/saeol/gosi/list.do?mid=0301020000&token=1757579444532',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '#conts table.bod_list  tbody tr'
        })
