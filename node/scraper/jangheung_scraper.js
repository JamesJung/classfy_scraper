        ...
        while (retries < maxRetries) {
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const fileLinks = document.querySelectorAll('a[title$="다운로드"]');
                    ...
                    fileLinks.forEach(link => {
                        ...
                        const fileName = link.getAttribute('title').replace(' 다운로드', '');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.jangheung.go.kr/www/organization/news/notification',
            required: true
        })
