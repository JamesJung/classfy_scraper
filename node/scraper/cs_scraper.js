            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#body_content', '#contBody', '.board', '.contents_wrap', '.program--contents',
                    ...
                    const goDownloadLinks = document.querySelectorAll('dl.attach a');
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.cs.go.kr/news/00002679/00006203.web',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.list1table4 li'
        })
