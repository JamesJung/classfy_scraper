            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        'table.p-table', '.bbs1view1', '.content_box', '.program--contents',
                    ...
                    const anchorTags = document.querySelectorAll('div.attach1 ul li a.filename');
                    const attachments = [];

                    anchorTags.forEach(anchor => {
                        // 파일 이름은 <a> 태그의 텍스트 콘텐츠입니다.
                        const fileName = anchor.textContent.trim();
                        // 다운로드 링크는 <a> 태그의 href 속성입니다.
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.namhae.go.kr/modules/saeol/gosi.do?&pageCd=SM010110000&siteGubun=socialm&_csrf_parameterName=CSRFToken&_csrf_token=952e47cb-a1d1-4abf-882c-4eb16efe2afd',
            required: true
        })
