            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        'table.p-table', '.bbs_view', '.content_box', '.program--contents',
                    ...
                    const fileListItems = document.querySelectorAll('#fileListCollap li');
                    const attachments = [];
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.gangnam.go.kr/notice/list.do?mid=ID05_040201',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.notice table.table tbody tr'
