            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#board_basic_view', '.content', '.main', '.article', '.post',
        ...
        try {
            ...
            await this.page.evaluate((params) => {
                ...
                if (typeof fn_egov_downFile === 'function') {
                    ...
                    form.method = 'post';
                    form.action = 'http://eminwon.wando.go.kr/emwp/jsp/ofr/FileDownNew.jsp';
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.wando.go.kr/wando/sub.cs?m=318',
            required: true
        })
