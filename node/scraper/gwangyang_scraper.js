                    ...
                    fileItems.forEach(item => {
                        ...
                        if (downloadLink) {
                            ...
                            if (matches && matches.length === 4) {
                                ...
                                const fullUrl = `https://eminwon.gwangyang.go.kr/emwp/jsp/ofr/FileDownNew.jsp?user_file_nm=${enc_user_file_nm}&sys_file_nm=${enc_sys_file_nm}&file_path=${enc_file_path}`;
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://gwangyang.go.kr/saeol/gosi.es?mid=a11005020000&type_code=02,04',
            required: true
        })
