                ...
                const announcements = await this.page.evaluate((selectors) => {
                    ...
                    rows.forEach((row, index) => {
                        ...
                        if (titleElement && dateElement) {
                            ...
                            const dateText = dateElement.textContent.trim().replace("등록일 : ", "");
            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#content', '#contBody', '.content', '.bbs1view1', '.program--contents',
                    ...
                    const fileLinks = document.querySelectorAll('div.attach1 ul li a.download, div.attach1 ul li a.filename');
                    let results = [];
        ...
        try {
            ...
            return {
                [fileName]: {
                    ...
                    downloadType: attachment.onclick ? 'javascript' : 'direct',
                    fileName: fileName
                }
            };
        } catch (error) {
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.gimhae.go.kr/03360/00023/00029.web',
            required: true
        })
        ...
        .option('date-selector', {
            ...
            default: 'a.a1 i.wrap1t3 span.t3:nth-child(2)'
        })
        .option('force', {
            alias: 'f',
            type: 'boolean',
