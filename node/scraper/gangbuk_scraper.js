            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#contents', 'tbody.p-table--th-left', '.bbs__view', '.content_box', '.program--contents',
                    ...
                    const fileLinks = document.querySelectorAll('.file-lists dd.item a.file');
                    const results = [];
        ...
        try {
            ...
            if (attachment.onclick) {
                ...
                if (goDownloadMatch) {
                    ...
                    downloadUrl = `https://eminwon.gangbuk.go.kr/emwp/jsp/ofr/FileDown.jsp?user_file_nm=${enc_user_file_nm}&sys_file_nm=${enc_sys_file_nm}&file_path=${enc_file_path}`;
            ...
            return {
                [fileName]: {
                    originalUrl: attachment.url,
                    originalOnclick: attachment.onclick,
                    actualDownloadUrl: actualDownloadUrl || downloadUrl,
                    downloadType: downloadType,
                    fileName: fileName
                }
            };
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.gangbuk.go.kr/portal/bbs/B0000245/list.do?menuNo=200082',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.bd-list table tbody tr'
        })
