            ...
            try {
                ...
                const content = await this.page.evaluate((options) => {
                    ...
                    const contentSelectors = [
                        '#content', '.board-view-ul', '.contents_wrap', '.program--contents',
                        '.bbs_skin', '.view_box',
...
function setupCLI() {
    return yargs
        ...
        .option('url', {
            ...
            type: 'string',
            description: '기본 URL',
            default: 'https://www.chungnam.go.kr/cnportal/province/province/list.do?menuNo=500487',
            required: true
        })
        .option('list-selector', {
            type: 'string',
            description: '리스트 선택자',
            default: '.txt-board table tbody tr'
        })
